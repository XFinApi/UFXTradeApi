######################################################
# UFXTradeApiSimpleDemoPythonPyCharmC2018_X64
# www.xfinapi.com
######################################################
...
# Python版本说明：Api使用64位python-3.6版本编译，建议开发时也使用该版本。#
...
class MarketTest:
    ...
    def test(self):
        self.market = XFinApi_TradeApi.XFinApi_CreateMarketApi("XTA_W64/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll")
...
class TradeTest:
    ...
    def Test(self):
        ...
        self.trade = XFinApi_TradeApi.XFinApi_CreateTradeApi(
            "XTA_W64/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll")
