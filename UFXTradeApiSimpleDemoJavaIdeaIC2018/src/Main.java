/*******************************************************
 * UFXTradeApiSimpleDemoJavaIdeaIC2018
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll", err);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll", err);
