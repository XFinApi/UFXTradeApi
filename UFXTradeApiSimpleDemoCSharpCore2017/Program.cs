/*******************************************************
* UFXTradeApiSimpleDemoCSharpCore2017
* www.xfinapi.com
*******************************************************/
using System;
...
namespace UFXTradeApiSimpleDemoCSharpCore2017
{
    class Program
    {
        //////////////////////////////////////////////////////////////////////////////////
        ...
        static void MarketTest()
        {
            ...
            market = ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll", out err);
        ...
        static void TradeTest()
        {
            ...
            trade = ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/UFX_V1.0.0.100/XFinApi.UFXTradeApi.dll", out err);
